...
#define OPENBLAS_HAVE_FMA4 
#define OPENBLAS_HAVE_FMA3 
#define OPENBLAS_HAVE_CFLUSH 
#define OPENBLAS_HAVE_MISALIGNSSE 
#define OPENBLAS_HAVE_128BITFPU 
#define OPENBLAS_HAVE_FASTMOVU 
#define OPENBLAS_NUM_SHAREDCACHE 1
#define OPENBLAS_NUM_CORES 1
#define OPENBLAS_CORE_PILEDRIVER 
#define OPENBLAS_CHAR_CORENAME "PILEDRIVER"
#define OPENBLAS_SLOCAL_BUFFER_SIZE 6144
#define OPENBLAS_DLOCAL_BUFFER_SIZE 5376
#define OPENBLAS_CLOCAL_BUFFER_SIZE 10752
#define OPENBLAS_ZLOCAL_BUFFER_SIZE 10752
