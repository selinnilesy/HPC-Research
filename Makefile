...
SSSconflictFree: SSSconflictFree.cpp header.h
	...
	g++  ../SPARSKIT2/BLASSM/matvec.o  SSSconflictFree.cpp  header.h ../SPARSKIT2/MATGEN/FDIF/functns.o ../SPARSKIT2/libskit.a  -o SSSconflictFree -std=c++17 -lstdc++fs -lgfortran
